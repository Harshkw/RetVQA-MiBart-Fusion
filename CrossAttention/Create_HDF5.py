...
def create_hdf5_from_images(image_folder, json_path, hdf5_file_path_images, hdf5_file_path_questions, hdf5_file_path_images_embed):
    ...
    with h5py.File(hdf5_file_path_images_embed, 'w') as hdf5_file:
        count = 0
        clip_model = CLIPModel.from_pretrained("/home/monu_harsh/Harshwardhan/mi_bart/Clip_FineTune/FineTunedModels/Epochs/clip_27.pth").to(device)
        clip_preprocess = CLIPProcessor.from_pretrained("/home/monu_harsh/Harshwardhan/mi_bart/Clip_FineTune/FineTunedModels/Epochs/clipProcessor_27.pth")
        for image_file in tqdm(image_files):
...
create_hdf5_from_images('/home/monu_harsh/Harshwardhan/mi_bart/RetVQA_Dataset/images/VG_100K', 
                        ...
                        '/home/monu_harsh/Harshwardhan/mi_bart/CrossAttention/RetVQA_Data_HDF5/images_embed_HDF5')