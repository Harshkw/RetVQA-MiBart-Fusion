...
class Trainer(TrainerBase):
    ...
    def evaluate_with_best(self, loader, dump_path=None):
        ...
        best_path = os.path.join(self.args.output, 'BEST')
        #self.load(best_path)
        #self.load("/home/iitm/Harshwardhan/mi_bart/pthFiles/VLBart/BEST")
...
def main_worker(gpu, args):
    ...
    # trainer.train()
    trainer.evaluate_with_best(test_loader, dump_path = "/home/iitm/Harshwardhan/mi_bart/Results/VLBart/val_results_paraphrased_v4.csv")
