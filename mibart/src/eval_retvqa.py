...
parser.add_argument("--gt_file", type=str, default="/home/iitm/Harshwardhan/mi_bart/RetVQA_Dataset/retvqa_release_v1.json") #
parser.add_argument("--result_file", type=str, default="/home/iitm/Harshwardhan/mi_bart/Results/VLBart/val_results_paraphrased_v4.json")
...
bart_scorer_ParaBank.load(path="/home/iitm/Harshwardhan/mi_bart/pthFiles/VLBart/bart_score.pth") # Please change the path to bart.pth
