...
class retvqa_QaDataset:
    ...
    def __init__(self, args, splits: str, verbose=True):  
        ...
        webqa_train_val_json = json.load(open("/home/monu_harsh/Harshwardhan/mi_bart/RetVQA_Dataset/retvqa_release_v1.json", 'rb'))
        ##just_for_pos_ones = json.load(open('/data1/abhiram/retvqa/final_retvqa_v4/train_val_test_v4.json', 'rb'))
        just_for_pos_ones = json.load(open("/home/monu_harsh/Harshwardhan/mi_bart/RetVQA_Dataset/retrieved_data_pos.json", 'rb'))
        ...
        for index, (key, value) in enumerate(webqa_train_val_json.items()):
            if webqa_train_val_json[key]['split'] == splits:
                ...
                image_sources.append(just_for_pos_ones[index][key])
