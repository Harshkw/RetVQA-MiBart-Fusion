...
parser.add_argument("--gt_file", type=str, default="/home/monu_harsh/Monu/dataset/retvqa_release_v1.json") #
parser.add_argument("--result_file", type=str, default="/home/monu_harsh/Monu/vqagit/mi_bart/snap/retvqa/VLBart/val_results_paraphrased_v5.json")
...
bart_scorer_ParaBank.load(path='/home/monu_harsh/Monu/vqagit/mi_bart/snap/pretrain/VLBart/bart_score.pth') # Please change the path to bart.pth
