...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from retvqa_model import VLBartWebQA_QA
        from retvqa_model import VLT5NLVR
    ...
    def evaluate_with_best(self, loader, dump_path=None):
        ...
        # self.load('/home/monu_harsh/Monu/vqagit/mi_bart/snap/pretrain/VLBart/BEST')
...
def main_worker(gpu, args):
    ...
    # trainer.train()
    trainer.evaluate_with_best(test_loader, dump_path = '/home/monu_harsh/Monu/vqagit/mi_bart/snap/retvqa/VLBart/val_results_paraphrased_final_miBart.csv')


if __name__ == "__main__":
    cudnn.benchmark = True
    args = parse_args()
    # print("argss          g g g gg g s",args)
