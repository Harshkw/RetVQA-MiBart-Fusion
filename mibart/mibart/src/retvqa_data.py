...
class retvqa_QaDataset:
    ...
    def __init__(self, args, splits: str, verbose=True):  
        ...
        webqa_train_val_json = json.load(open('/home/monu_harsh/Monu/dataset/retvqa_release_v1.json', 'rb'))  

        just_for_pos_ones = json.load(open('/home/monu_harsh/Monu/dataset/retrieved_data_pos_all_finetune_attention.json', 'rb'))
