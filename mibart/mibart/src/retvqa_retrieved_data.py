...
# webqa_feature_dir = "/home/monu_harsh/Monu/vqagit/mi_bart/datasets/VG/features"
...
class retvqa_QaDataset:
    ...
    def __init__(self, args, splits: str, verbose=True):  
        ...
        retrieved_sources = json.load(open('/home/monu_harsh/Monu/dataset/retvqa_release_v1.json', 'rb'))
